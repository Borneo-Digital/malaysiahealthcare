...
export function Home4ContinuedSupportCTA() {
    ...
    <section className="text-white space-y-12">
          ...
          >
            {option.featured && (
              <div className="absolute top-4 right-4">
                <Badge className="bg-mhtc-primary text-white">
            ...
            <CardContent className="p-6 text-grey-900">
              ...
              <div className="space-y-3 mb-6">
                {option.benefits.map((benefit, idx) => (
                  <div key={idx} className="flex items-center gap-3 p-2 bg-white/50 rounded-lg">
                    <CheckCircle className="h-4 w-4 text-mhtc-primary flex-shrink-0" />
                    <span className="text-grey-700 text-sm">{benefit}</span>
                  </div>
                ))}
              </div>
              ...
              <Button 
                className={`w-full group-hover:scale-105 transition-all duration-300 ${
                  option.featured 
                    ? 'bg-mhtc-primary hover:bg-[#A50E25] text-white' 
                    : 'bg-grey-900 hover:bg-grey-800 text-white'
                }`}
              >
                {option.cta}
      ...
      <div className="text-center space-y-6 pt-8 border-t border-white/20">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <Button 
            size="lg"
            className="bg-white text-mhtc-primary hover:bg-white/90 px-8 py-6 h-auto text-lg font-medium hover:scale-105 transition-all duration-300"
          >
          ...
          <Button 
            size="lg"
            variant="outline"
            className="border-2 border-white text-white hover:bg-white hover:text-mhtc-primary bg-transparent px-8 py-6 h-auto text-lg font-medium hover:scale-105 transition-all duration-300"
          >
