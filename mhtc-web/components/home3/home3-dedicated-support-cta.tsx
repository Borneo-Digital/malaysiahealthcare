...
export function Home3DedicatedSupportCTA() {
  return (
    <section className="space-y-12">
            ...
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                <div className="inline-block p-4 bg-white rounded-full shadow-sm group-hover:shadow-md transition-all duration-300">
                  <option.icon className="h-8 w-8 text-[#BE1E2D]" />
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {supportFeatures.map((feature, index) => (
            <div key={index} className="text-center space-y-4">
              <div className="inline-block p-4 bg-[#BE1E2D]/10 rounded-full">
                <feature.icon className="h-8 w-8 text-[#BE1E2D]" />
              </div>
              <div>
      ...
      <div className="text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-[#BE1E2D] hover:bg-[#A01825] px-8">
            <Phone className="h-5 w-5 mr-2" />
            Call MHTC Now
          </Button>
          <Button size="lg" variant="outline" className="border-[#BE1E2D] text-[#BE1E2D] px-8">
