...
export function Home3ExpertConsultCTA() {
  return (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-800">{option.duration}</span>
                    </div>
                  </div>
                  ...
                  <Button 
                    size="lg"
                    className="w-full bg-[#BE1E2D] hover:bg-[#A01825] group-hover:scale-105 transition-all"
                  >
                    {option.action}
        ...
        <div className="text-center pt-4">
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                className="bg-white text-[#BE1E2D] hover:bg-white/90 hover:scale-105 transition-all px-8"
              >
