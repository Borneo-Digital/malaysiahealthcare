...
export function Home3ArrivalHero() {
  ...
  return (
    <section className="relative min-h-[80vh] bg-gradient-to-br from-green-50 via-white to-blue-50/30 flex items-center overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-16 right-16 w-40 h-40 bg-[#BE1E2D]/5 rounded-full animate-pulse"></div>
        <div className="absolute bottom-16 left-16 w-32 h-32 bg-green-500/5 rounded-full animate-pulse delay-1000"></div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Welcome to
                <span className="block text-[#BE1E2D]">Malaysia</span>
              </h1>
              ...
              {malaysiaWelcome.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                  <div className="p-2 bg-[#BE1E2D]/10 rounded-lg">
                    <feature.icon className="h-5 w-5 text-[#BE1E2D]" />
                  </div>
              ...
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <div className="inline-block p-4 bg-[#BE1E2D]/10 rounded-full mb-4">
                    <Clock className="h-8 w-8 text-[#BE1E2D]" />
                  </div>
