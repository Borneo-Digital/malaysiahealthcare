  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main id="main-content">
        ...
        <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Malaysia Healthcare Hero Background"
              fill
              sizes="100vw"
        ...
        >
          <div className="container mx-auto text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg" tabIndex={0}>
              We&apos;re with you every step of the way. Explore our
              comprehensive health travel journey designed for your comfort and
              peace of mind.
            </p>
          </div>
          <JourneyBridge />
        ...
        <section
          className="bg-pattern bg-gray-50 py-16 sm:py-24"
